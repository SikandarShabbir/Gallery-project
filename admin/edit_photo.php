            ...
            <div class="col-lg-12">
                ...
                <form action="" method="POST">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <a href="" class="img-thumbnail"><img src="<?= $photo->picture_path(); ?>"  alt="" width="300"></a>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" value="<?= $photo->description; ?>" id="" cols="30" rows="10"><?= $photo->description; ?></textarea>
                        </div>
                    </div>
